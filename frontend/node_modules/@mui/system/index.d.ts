...
export {
    CSSInterpolation,
    CSSObject, Interpolation, StyledEngineProvider, css,
    keyframes
...
export {
    unstable_createStyleFunctionSx, unstable_defaultSxConfig, extendSxProp as unstable_extendSxProp, default as unstable_styleFunctionSx
...
export { Spacing, SpacingOptions, default as createSpacing } from '@mui/system/createTheme/createSpacing';

export * from '@mui/system/createTheme/shape';
export { default as shape } from '@mui/system/createTheme/shape';

export { getThemeProps, default as useThemeProps } from '@mui/system/useThemeProps';
...
export { CreateCssVarsProviderResult, default as unstable_createCssVarsProvider } from '@mui/system/cssVars';
